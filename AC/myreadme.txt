...
--ckpt experiment/experiment_MGFA_7/stage3/checkpoints/0030000.pt \
--captioner none \
--cfg_scale 1.0 \
--noise_aug 0 \
--input datasets/ZZCX_3_3/test/LQ \
--condition_path datasets/ZZCX_3_3/test/condition_swinir_LQ \
--rgb_path datasets/ZZCX_3_3/test/RGB_HQ \
--output results/3.29/MGFA_test_6 \
--precision fp32 \
--sampler spaced \
--steps 50 \
--pos_prompt '' \
...
find datasets/ZZCX_3_3/train_RGB/edge -type f > datasets/ZZCX_3_3/train_RGB/edge.list
